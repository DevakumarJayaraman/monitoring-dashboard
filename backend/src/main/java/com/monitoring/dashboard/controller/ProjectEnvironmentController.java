...
public class ProjectEnvironmentController {
    ...
    public ResponseEntity<List<ProjectEnvironmentDTO>> getAllEnvironments() {
        log.info("GET /api/environments - Fetching all environments");
    ...
    public ResponseEntity<ProjectEnvironmentDTO> getEnvironmentById(
        ...
        log.info("GET /api/environments/{} - Fetching environment", id);
    ...
    public ResponseEntity<List<ProjectEnvironmentDTO>> getEnvironmentsByProject(
            @Parameter(description = "Project ID") @PathVariable Long projectId) {
        log.info("GET /api/environments/project/{} - Fetching environments", projectId);
    ...
    public ResponseEntity<List<ProjectEnvironmentDTO>> getEnvironmentsByEnvCode(
        ...
        log.info("GET /api/environments/envcode/{} - Fetching environments", envCode);
    ...
    public ResponseEntity<List<ProjectEnvironmentDTO>> getEnvironmentsByRegion(
        ...
        log.info("GET /api/environments/region/{} - Fetching environments", regionCode);
    ...
    public ResponseEntity<List<ProjectEnvironmentDTO>> getEnvironmentsByProfile(
        ...
        log.info("GET /api/environments/profile/{} - Fetching environments", profileCode);
    ...
    public ResponseEntity<List<String>> getAllProfiles() {
        log.info("GET /api/environments/profiles - Fetching all profile codes");
