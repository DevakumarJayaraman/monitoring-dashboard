    ...
    },
    {
      ...
      icon: (
        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6V4m0 16v-2m8-6h2M2 12h2m12.364-5.364l1.414-1.414M6.222 17.778l1.414-1.414m0-10.95L6.222 4.95m10.95 10.95l1.414 1.414M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
        </svg>
      ),
    },
  ];
