import type { InfraType, ServiceStatus, StatusLevel } from "../../types/infrastructure";
import { infraTypeConfig, serviceStatusConfig, statusConfig } from "../../features/infrastructure/config";
